      ...
      <div className="mx-auto max-w-3xl">
        <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-16 mx-4">
          <div className="item space-y-20">
            <div>
              <h1 className="text-3xl">Hey! I'm Souradeep Ghosh</h1>
    ...
    <section className="px-6 py-16 text-[#171618]" id="about">
      <div className="mx-auto max-w-3xl">
        <div className="grid gap-4 mx-4">
          ...
          <p className="text-zinc-600">I am currently a Software Developer with a strong focus on Full Stack Development, particularly using MERN and Next.js. I have experience working on various projects such as 'YOOM' (a video conference tool), 'MOVIX' (a movie exploration platform), 'Crypto Marketplace' (a cryptocurrency data display tool), and more. I also actively contribute to open-source projects and have a passion for backend development and cloud technologies.</p>
          <p className="pt-3 text-zinc-600">
            In 2025, I will complete my Bachelor's degree in Electronics and Communications Engineering from Narula Institute of Technology, West Bengal, India. I have solved over 1000 algorithmic problems on platforms like LeetCode and GfG, which have greatly improved my problem-solving and coding skills.
          </p>
          <p className="pt-3 text-zinc-600">
            I have participated in multiple hackathons, such as Hack4Bengal, where I led my team to secure 4th place out of 50 teams. Additionally, I have contributed to open-source projects and communities like Social Winter of Code and GirlScript Summer of Code, gaining hands-on experience in real-world projects.
          </p>
